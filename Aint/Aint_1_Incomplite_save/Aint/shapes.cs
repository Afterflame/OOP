...
namespace Aint
{
    public partial class Form1 : Form
    {
        private class Shape
        {
            ...
            public Shape(Point f_point, Pen pen, Brush brush)
            {
                this.name = "Shape";
        ...
        {
            public LineObj(Point f_point, Pen pen, Brush brush)
                : base(f_point, pen, brush)
            {
                this.name = "LineObj";
            }
        ...
        {
            public RectangleObj(Point f_point, Pen pen, Brush brush)
                : base(f_point, pen, brush)
            {
        ...
        {
            public EllipseObj(Point f_point, Pen pen, Brush brush)
                : base(f_point, pen, brush)
            {
        ...
        private class PieObj : Shape
        {
            ...
            public PieObj(Point f_point,  Pen pen, Brush brush, float start_angle, float slice_angle)
                : base(f_point, pen, brush)
            {
                this.name = "PieObj";

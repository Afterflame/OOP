...
namespace Aint
{
    public partial class Form1 : Form
    {
        ...
        private class Bruh : SinglePointTool
        {
            ...
            {
                Store();
                shape = new LineObj(p1, this.pen, this.brush);
                shape.ChangeP2(p2);
                shape.Draw(this.pBox);
            }
        }
        ...
        private class Liner : DoublePointTool
        {
            ...
            public override void MouseDown(Point cur_p)
            {
                this.Store();
                this.start_p = cur_p;
                shape = new LineObj(this.start_p,  this.pen, this.brush);
                shape.ChangeP2(cur_p);
                shape.Draw(this.pBox);
            }
            public override void MouseDown_Move(Point cur_p)
            {
        ...
        private class RectTool : DoublePointTool
        {
            ...
            public override void MouseDown(Point cur_p)
            {
                this.Store();
                this.start_p = cur_p;
                shape = new RectangleObj(this.start_p,  this.pen, this.brush);
                shape.Draw(this.pBox);
            }
            public override void MouseDown_Move(Point cur_p)
            {
        ...
        private class EllipseTool : DoublePointTool
        {
            ...
            public override void MouseDown(Point cur_p)
            {
                this.Store();
                this.start_p = cur_p;
                shape = new EllipseObj(this.start_p,  this.pen, this.brush);
                shape.ChangeP2(cur_p);
                shape.Draw(this.pBox);
            }
            public override void MouseDown_Move(Point cur_p)
        ...
        private class Lupa2p : DoublePointTool
        {
            ...
            public override void MouseDown(Point cur_p)
            {
                this.Store();
                start_p = cur_p;
                shape = new RectangleObj(cur_p, this.pen, this.brush);
                Act(cur_p);
            }
            public override void MouseDown_Move(Point cur_p)
            {
        ...
        private class PieTool : DoublePointTool
        {
            ...
            public override void MouseDown(Point cur_p)
            {
                this.Store();
                this.start_p = cur_p;
                shape = new PieObj(this.start_p, this.pen, this.brush, (float)(360 / angleTB1.max_v * angleTB1.value), (float)(360 / angleTB2.max_v * angleTB2.value));
                shape.ChangeP2(cur_p);
                shape.Draw(this.pBox);
            }
            public override void MouseDown_Move(Point cur_p)
